...
# SkiaSharp (usado pelo QuestPDF para renderizar o DANFE) precisa de fontconfig/freetype,
# que nao vem na imagem aspnet. curl e usado pelo healthcheck do docker-compose.
RUN apt-get update \
